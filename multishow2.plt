...
# SETUP COMMANDS
#==============================================================================
set yrange [0.000000:1754.000000]

set ylabel 'degrés LastFM' enhanced textcolor '#404040'
...
#==============================================================================
plot \
    'plot2.dat' index 0 using 0:2:3:xtic(1) notitle with boxes linestyle 1 linewidth 2 fillcolor 'pink' fillstyle solid 0.5 border
